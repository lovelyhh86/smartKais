$(function () {
    ...
    function makeFacInfo(data) {
        ...
        var infolist = [
            ...
            { key: '설치지점', value: data.instSpotCdLbl, property: 'instSpotCd', dropdownCode: 'GFTY015', codeList: [] },
            { key: '설치/재설치 여부', value: data.isLgnYnLbl, property: 'isLgnYn', dropdownCode: 'GFTY016', codeList: [] },
            ...
            { key: '안내시설형식', value: data.gdftyFormLbl, property: 'gdftyForm', dropdownCode: 'GFTY012', codeList: [] },
            { key: '안내시설방향', value: data.plqDirectionLbl, property: 'plqDirection', dropdownCode: 'GFTY014', codeList: [] }
            ...
            //     {key:'양면여부',value:data.bdrclAtLbl, property:'bdrclAt', codeList: {'01': '예', '02':'아니오'}}
            /*
            ,
    ...
    function createDropDown(items) {
        ...
        for (var key in items.list) {
            var selected = "";
            if (selectname == list[key])
                selected = "selected";
            options += '<option value="' + key + '" ' + selected + '>' + list[key] + "</option>";
        }
    ...
    function makeDetailInfo(infolist) {
        ...
        if (util.isEmpty(infolist) === false) {
            ...
            for (var index = 0; index < infolist.length; index++) {
                ...
                if (infolist[index].codeList) {
                    fieldContent = createDropDown({ value: val, property: infolist[index].property, list: infolist.codeList });
