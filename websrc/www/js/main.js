...
var msg = {
    ...
    successSpgfInsertPoint : "KAIS WEB\n(안내시설관리>도로시설물>도로시설물위치관리)\n에서 저장된 위치 이동정보를 확인하세요.",
    successNmtgInsertPoint : "KAIS WEB\n(안내시설관리>도로시설물>건물번호판위치관리)\n에서 저장된 위치 이동정보를 확인하세요.",
    ...
    agreePersonCoodi: '◼︎위치정보 수집 및 이용' +
                    '\n' +
                    '①수집 이용 목적' +
                    '\n' +
                    '- 시설물의 위치정보를 측정하여 정확한 위치정보 파악' +
                    '\n\n' +
                    '②수집 및 이용항목' +
                    '\n' +
                    '- GPS 위치정보' +
                    ...
                    '\n' +
                    '- 위치정보 수집 및 이용에 대한 동의를 거부할 권리가 있습니다.'+
                    '\n' +
                    '- 동의 거부시 별도의 불이익은 없으며 본 어플리케이션의 이용에 제한이 발생합니다.'
